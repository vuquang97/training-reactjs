            ...
            <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <div className="dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
                        ...
                        <li className="drop-dow" onClick={() => this.onClick('status', -1)}>Đang chiếu&nbsp;{ (sortBy === 'status' && sortValue === -1) ? <i className="fas fa-check-circle"></i> : '' }</li>
                        <li className="drop-dow" onClick={() => this.onClick('status', 1)}>Sắp chiếu&nbsp;{ (sortBy === 'status' && sortValue === 1) ? <i className="fas fa-check-circle"></i> : '' }</li>
                    </ul>
                </div>
            </div>
        );
